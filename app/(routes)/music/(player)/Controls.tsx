...
export default function Controls() {
  ...
  return (
    <div
      className={`track relative flex h-10 w-full flex-row items-center justify-center overflow-hidden rounded-full border border-current px-2 py-1 shadow-md transition-all ${
